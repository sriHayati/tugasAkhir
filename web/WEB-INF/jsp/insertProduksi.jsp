<%-- 
    Document   : insertProduksi
    Created on : Jul 8, 2019, 12:11:02 AM
    Author     : acer v5
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <center><h2 > Tambah Data Produksi</kh2>   </center>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form id="produksi" action="saveDataProduksi.htm" modelAttribute="produksiDto" method="POST">
                                <br><br><br><br>
                                ...
                                <center><table id="customers">
                                        ...
                                        <tr>
                                            ...
                                            <td><form:input path="tanggal_produksi" class="validate validate[required, minSize[3], custom[onlyLetterNumberPoint], custom[noSpace]]"/></td>
                                        </tr>

                                        <tr>
                                            <td>Kode Produk :</td>
                                            <td><form:select path="kode_produk">
                                                    <form:option value="" class="validate validate[required]" id="kode_produk" selected="true" disabled="true">Pilih Kode Produk</form:option>
