<%-- 
    Document   : updateDataAkun
    Created on : Aug 24, 2019, 2:19:50 PM
    Author     : acer v5
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <center><h2 > Update Data Akun</h2>   </center>
                    ...
                    <div class="row">
                        <div class="col-md-12">       
                            <form:form id="akunUpdate" action="updateDataAkun.htm" modelAttribute="akunDto" method="POST">
                                <form:hidden path="kode_akun" value="${akunDto.kode_akun}" />
                                <br><br><br><br>
                                <center><h1>Form Update Data Akun</h1></center>
                                <br><br>
                                <center><table id="customers">
                                        <tr>
                                            <td> Kode Akun :</td>
                                            <td> ${akunDto.kode_akun}</td>             
                                        </tr>
                                        <tr>
                                            <td>Nama Akun :</td>
                                            <td><form:input path="nama_akun" value="${akunDto.nama_akun}" class="validate validate[required, maxSize[100], custom[onlyLetter]]"/></td>
                                        </tr>
                                        <tr>
                                            <td>Deskripsi :</td>
                                            <td><form:input path="deskripsi" value="${akunDto.deskripsi}" /></td>            
                                        </tr>        
                                        <tr>
                                            <td colspan="2">
