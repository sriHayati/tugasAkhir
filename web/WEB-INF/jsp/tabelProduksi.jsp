<%-- 
    Document   : tabelProduksi
    Created on : Jul 7, 2019, 5:09:04 PM
    Author     : acer v5
--%>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <center><h2 > Data Produksi</h2>   </center>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <center>
                            <c:url var="tambahDataProduksi" value="/doTambahDataProduksi.htm">        
                            </c:url>
                            <a href="${tambahDataProduksi}">Tambah</a>    
                            <table id="customers">
                                <tr>
                                    <th>No</th> 
                                    <th>Kode Produksi</th>            
                                ...
                                <c:forEach var="listProduksi" items="${listProduksiDto}">
                                    <tr>  
                                        <td>${index}</td>
                                        <td>${listProduksi.kode_produksi}</td>
                                        <td>${listProduksi.tanggal_produksi}</td>
                                        <td>${listProduksi.kode_produk}</td>
                                        <td>${listProduksi.jumlah}</td>
                                        <td>${listProduksi.keterangan}</td>

                                        <c:url var="deleteProduksi" value="/deleteDataProduksi.htm">
                                            <c:param name="kode_produksi" value="${listProduksi.kode_produksi}"/>
                                            <c:param name="kode_produk" value="${listProduksi.kode_produk}"/>
                                            <c:param name="jumlah" value="${listProduksi.jumlah}"/>
                                        </c:url>
                                        <c:url var="updateProduksi" value="/getDataUpdateProduksi.htm">
                                            <c:param name="kode_produksi" value="${listProduksi.kode_produksi}"/>
                                        </c:url>
                                        <td><a href="${deleteProduksi}">delete</a></td>
                                        <td><a href="${updateProduksi}">update</a></td>
                                    </tr>            
