<%-- 
    Document   : data_customer
    Created on : Jul 28, 2019, 11:36:37 PM
    Author     : acer v5
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <center><h2 > Tambah Data Customer</h2>   </center>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form id="siswa" action="saveDataCustomer.htm" modelAttribute="customerDto" method="POST">
                                <br><br><br><br>
                                ...
                                <center><table id="customers">
                                        ...
                                        <tr>
                                            ...
                                            <td><form:input path="tanggal_penjualan"/></td>
                                        </tr>

                                        <tr>
                                            <td>nama Customer :</td>
                                            <td><form:input path="nama_customer" /></td>
                                        </tr>
                                        <tr>
                                            <td>Alamat Customer :</td>
                                            <td><form:input path="alamat_customer" /></td>
                                        </tr>
