<%-- 
    Document   : updateKategori
    Created on : Jul 8, 2019, 1:03:26 AM
    Author     : acer v5
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <center><h2 > Update Data Kategori</h2>   </center>
                    ...
                    <div class="row">
                        <div class="col-md-12">       
                            <form:form id="kategoriUpdate" action="updateKategori.htm" modelAttribute="kategoriDto" method="POST">
                                ...
                                <br><br><br><br>
                                <center><h1>Form Update Data Kategori</h1></center>
                                <br><br>
                                <center><table id="customers">
                                        <tr>
                                            <td> Kode Kategori :</td>
                                            <td> ${kategoriDto.kode_kategori}</td>             
                                        </tr>
                                        <tr>
                                            <td>nama_kategori :</td>
                                            <td><form:input path="nama_kategori" value="${kategoriDto.nama_kategori}" class="validate validate[required, maxSize[100], custom[onlyLetter]]"/></td>
                                        </tr>
                                        <tr>
                                            <td>keterangan :</td>
                                            <td><form:input path="keterangan" value="${kategoriDto.keterangan}" /></td>            
                                        </tr>        
                                        <tr>
                                            <td colspan="2">
