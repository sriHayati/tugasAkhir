<%-- 
    Document   : insertPenjualan
    Created on : Jul 29, 2019, 12:19:48 AM
    Author     : acer v5
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <center><h2 > Tambah Data Penjualan</h2>   </center>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <%--<c:set var="kode" value="customerDto"></c:set>--%>
                            <form:form id="siswa" action="saveDataPenjualan.htm" modelAttribute="penjualanDto" method="POST">
                                ...
                                <center><table id="customers">
                                        <tr>
                                            ...
                                            <td><form:input path="kode_penjualan" /></td>
                                        </tr>
                                        <tr>
                                            <td>Kode Pelanggan :</td>
                                            <td> <form:input path="kode_customer" value="${penjualanDtoo.kode_customer}" readonly="true"/></td>
                                        </tr>        
                                        <tr>
                                            <td>Kode Produk :</td>
