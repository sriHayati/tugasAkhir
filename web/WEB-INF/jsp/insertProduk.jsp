<%-- 
    Document   : insertProduk
    Created on : Jul 7, 2019, 11:17:03 PM
    Author     : acer v5
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <center><h2 > Tambah Data Produk</kh2>   </center>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form id="produk" action="saveDataProduk.htm" modelAttribute="produkDto" method="POST">
                                <br><br><br><br>
                                ...
                                <center><table id="customers">
                                        ...
                                        <tr>
                                            <td>Kode Kategori :</td>
                                            <td><form:select path="kode_kategori">
                                                    <form:option value="" class="validate validate[required]" id="kode_kategori" selected="true" disabled="true">Pilih Kode Kategori</form:option>
                                        ...
                                        <tr>
                                            <td>Nama Produk :</td>
                                            <td><form:input path="nama_produk" /></td>
                                        </tr>
                                        <tr>
                                            <td>Harga Jual :</td>
                                            <td><form:input path="harga_jual" /></td>
                                        </tr>
                                        <tr>
                                            <td>Stok Minimum :</td>
                                            <td><form:input path="stok_minimum" /></td>
                                        </tr>
                                        <tr>
                                            <td>Keterangan :</td>
                                            <td><form:input path="keterangan" /></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
