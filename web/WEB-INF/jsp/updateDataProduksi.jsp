<%-- 
    Document   : updateDataProduksi
    Created on : Jul 24, 2019, 4:37:15 PM
    Author     : acer v5
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <center><h2 > Update Data Produksi</h2>   </center>
                    ...
                    <div class="row">
                        <div class="col-md-12">       
                            <c:url var="untJumlah" value="${produksiDto.jumlah}"></c:url>
                            <form:form id="dataProduksiUpdate" action="updateDataProduksi.htm" modelAttribute="produksiDto" methodParam="${untJumlah}" method="POST">
                                <form:hidden path="kode_produksi" value="${produksiDto.kode_produksi}" />
                                
                                <br><br><br><br>
                                <center><h1>Form Update Data Produksi</h1></center>
                                <br><br>
                                <center><table id="customers">
                                        <tr>
                                            <td> Kode Produksi :</td>
                                            <td> ${produksiDto.kode_produksi}</td>             
                                        </tr>
                                        <tr>
                                            <td>Tanggal Produksi :</td>
                                            <td><form:input path="tanggal_produksi" value="${produksiDto.tanggal_produksi}" /></td>            
                                        </tr> 
                                        <tr>
                                            <td>Kode Produk :</td>
                                            <td><form:select path="kode_produk" value="${produksiDto.kode_produk}">
                                                    <form:option value="" class="validate validate[required]" id="kode_produksi" selected="true" disabled="true">Pilih Kode Produk</form:option>
                                        ...
                                        <tr>
                                            <td>Jumlah :</td>
                                            <td><form:input path="jumlah" value="${produksiDto.jumlah}" /></td>            
                                        </tr>  

                                        <tr>
                                            <td>Keterangan :</td>
                                            <td><form:input path="keterangan" value="${produksiDto.keterangan}" /></td>            
                                        </tr>
                                        <tr>
                                            <td colspan="2">
