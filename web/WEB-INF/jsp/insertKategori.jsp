<%-- 
    Document   : insertKategori
    Created on : Jul 7, 2019, 8:21:50 PM
    Author     : acer v5
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <center><h2 > Tambah Data Kategori</h2>   </center>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form id="siswa" action="saveDataKategori.htm" modelAttribute="kategoriDto" method="POST">
                                <br><br><br><br>
                                ...
                                <center><table id="customers">
                                        ...
                                        <tr>
                                            <td>Nama Kategori </td>
                                            <td><form:input path="nama_kategori"/></td>
                                        </tr>
