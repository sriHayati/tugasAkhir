<%-- 
    Document   : tabelAkun
    Created on : Aug 24, 2019, 8:30:27 AM
    Author     : acer v5
--%>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <center>
                                ...
                                <a href="${tambahDataAkun}">Tambah</a>    
                                <table id="customers">
                                    <tr>
                                        <th>No</th> 
                                        <th>Kode Akun</th>            
                                    ...
                                    <c:forEach var="listAkun" items="${listAkunDto}">
                                        <tr>  
                                            ...
                                            <td><a href="${deleteAkun}">delete</a></td>
                                            <td><a href="${updateAkun}">update</a></td>
                                        </tr>            
