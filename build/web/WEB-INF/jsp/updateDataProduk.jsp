<%-- 
    Document   : updateDataProduk
    Created on : Jul 24, 2019, 2:25:00 PM
    Author     : acer v5
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <center><h2 > Update Data Produk</kh2>   </center>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form id="dataProdukUpdate" action="updateDataProduk.htm" modelAttribute="produkDto" method="POST">
                                <form:hidden path="kode_produk" value="${produkDto.kode_produk}" />
                                <br><br><br><br>
                                <center><h1>Form Update Data Produk</h1></center>
                                <br><br>
                                <center><table id="customers">
                                        <tr>
                                            <td> Kode Produk :</td>
                                            <td> ${produkDto.kode_produk}</td>             
                                        </tr>
                                        <tr>
                                            <td>Kode Kategori :</td>
                                            <td><form:select path="kode_kategori" value="${produkDto.kode_kategori}">
                                                    <form:option value="" class="validate validate[required]" id="kode_produk" selected="true" disabled="true">Pilih Kode Kategori</form:option>
                                                    <c:forEach var="kk" items="${listkp}">
                                                        <form:option value="${kk.kode_kategori}">${kk.kode_kategori}</form:option>
                                                    </c:forEach>
                                                </form:select></td>
                                        </tr>
                                        <tr>
                                            <td>Nama Produk :</td>
                                            <td><form:input path="nama_produk" value="${produkDto.nama_produk}" /></td>            
                                        </tr>  
                                        <tr>
                                            <td>Harga Jual :</td>
                                            <td><form:input path="harga_jual" value="${produkDto.harga_jual}" /></td>            
                                        </tr>
                                        <tr>
                                            <td>Stok Minimum :</td>
                                            <td><form:input path="stok_minimum" value="${produkDto.stok_minimum}" /></td>            
                                        </tr>
                                        <tr>
                                            <td>Keterangan :</td>
                                            <td><form:input path="keterangan" value="${produkDto.keterangan}" /></td>            
                                        </tr>
                                        <tr>
                                            <td colspan="2">
