<%-- 
    Document   : insertAkun
    Created on : Aug 23, 2019, 10:23:29 AM
    Author     : acer v5
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <center><h2 > Tambah Data Akun</h2>   </center>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form id="siswa" action="saveDataAkun.htm" modelAttribute="akunDto" method="POST">
                                <br><br><br><br>
                                ...
                                <center><table id="customers">
                                        <tr>
                                            <td>Kode Akun :</td>
                                            <td><form:input path="kode_akun" class="validate validate[required, minSize[3], custom[onlyLetterNumberPoint], custom[noSpace]]"/></td>
                                        </tr>        
                                        <tr>
                                            <td>Nama Akun :</td>
                                            <td><form:input path="nama_akun"/></td>
                                        </tr>
