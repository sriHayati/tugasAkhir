<%-- 
    Document   : updateDataPengeluaran
    Created on : Aug 24, 2019, 2:44:16 PM
    Author     : acer v5
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <center><h2 > Update Data Pengeluaran</h2>   </center>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form id="dataPengeluaranUpdate" action="updateDataPengeluaran.htm" modelAttribute="pengeluaranDto" method="POST">
                                <form:hidden path="kode_pengeluaran" value="${pengeluaranDto.kode_pengeluaran}" />
                                <br><br><br><br>
                                <center><h1>Form Update Data Pengeluaran</h1></center>
                                <br><br>
                                <center><table id="customers">
                                        <tr>
                                            <td> Kode Pengeluaran :</td>
                                            <td> ${pengeluaranDto.kode_pengeluaran}</td>             
                                        </tr>
                                        <tr>
                                            <td>Tanggal :</td>
                                            <td><form:input path="tanggal" value="${pengeluaranDto.tanggal}" /></td>            
                                        </tr>
                                        <tr>
                                            <td>Kode Akun :</td>
                                            <td><form:select path="kode_akun" value="${pengeluaranDto.kode_akun}">
                                                    <form:option value="" class="validate validate[required]" id="kode_akun" selected="true" disabled="true">Pilih Kode Akun</form:option>
                                                    <c:forEach var="kk" items="${listkp}">
                                                        <form:option value="${kk.kode_akun}">${kk.kode_akun}</form:option>
                                                    </c:forEach>
                                                </form:select></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>Deskripsi :</td>
                                            <td><form:input path="deskripsi" value="${pengeluaranDto.deskripsi}" /></td>            
                                        </tr>
                                        <tr>
                                            <td>Jumlah :</td>
                                            <td><form:input path="jumlah" value="${pengeluaranDto.jumlah}" /></td>            
                                        </tr>
