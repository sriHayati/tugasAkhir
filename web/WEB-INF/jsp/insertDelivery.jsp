<%-- 
    Document   : insertDelivery
    Created on : Jul 27, 2019, 12:21:14 AM
    Author     : acer v5
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <center><h2 > Tambah Data Delivery</h2>   </center>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form id="siswa" action="saveDataDelivery.htm" modelAttribute="deliveryDto" method="POST">
                                <br><br><br><br>
                                ...
                                <center><table id="customers">
                                        ...
                                        <tr>
                                            ...
                                            <td><form:input path="tanggal_delivery"/></td>
                                        </tr>
