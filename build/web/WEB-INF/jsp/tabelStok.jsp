<%-- 
    Document   : tabelStok
    Created on : Jul 7, 2019, 4:50:44 PM
    Author     : acer v5
--%>
                    ...
                    <div class="col-md-12">
                        ...
                        <center>
                            ...
                            <table id="customers">
                                ...
                                <c:forEach var="listStok" items="${listStokDto}">
                                    <tr>  
                                        <td>${index}</td>
                                        <td>${listStok.kode_produk}</td>
                                        <td>${listStok.stok_gudang}</td>
                                        <td>${listStok.stok_toko}</td>
                                        <td>${listStok.total_stok}</td>
