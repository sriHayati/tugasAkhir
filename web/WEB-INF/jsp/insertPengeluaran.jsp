<%-- 
    Document   : insertPengeluaran
    Created on : Aug 23, 2019, 10:24:07 AM
    Author     : acer v5
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <center><h2 > Tambah Data Pengeluaran<h2>   </center>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form id="pengeluaran" action="saveDataPengeluaran.htm" modelAttribute="pengeluaranDto" method="POST">
                                <br><br><br><br>
