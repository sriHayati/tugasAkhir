<%-- 
    Document   : tabelDelivery
    Created on : Jul 26, 2019, 10:28:09 PM
    Author     : acer v5
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <center><h2 > Data Delivery</h2>   </center>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <center>
                                <c:url var="tambahDataDelivery" value="/doTambahDataDelivery.htm">        
                                </c:url>
                                <a href="${tambahDataDelivery}">Tambah</a>    
                                <table id="customers">
                                    <tr>
                                        <th>No</th> 
                                        <th>Kode Delivery</th> 
                                    ...
                                    <c:forEach var="listDelivery" items="${listDeliveryDto}">
                                        <tr>  
                                            <td>${index}</td>
                                            <td>${listDelivery.kode_delivery}</td>
                                            <td>${listDelivery.tanggal_delivery}</td>
                                            <td>${listDelivery.keterangan}</td>
                                            <td>${listDelivery.kode_produk}</td>
                                            <td>${listDelivery.jumlah}</td>

                                            <c:url var="deleteDelivery" value="/deleteDataDelivery.htm">
                                                <c:param name="kode_delivery" value="${listDelivery.kode_delivery}"/>

                                                <c:param name="kode_produk" value="${listDelivery.kode_produk}"/>
                                                <c:param name="jumlah" value="${listDelivery.jumlah}"/>
                                            </c:url>
                                            <c:url var="updateDelivery" value="/getDataUpdateDelivery.htm">
                                                <c:param name="kode_delivery" value="${listDelivery.kode_delivery}"/>
                                            </c:url>
                                            <td><a href="${deleteDelivery}">delete</a></td>
                                            <td><a href="${updateDelivery}">update</a></td>
                                        </tr>            
